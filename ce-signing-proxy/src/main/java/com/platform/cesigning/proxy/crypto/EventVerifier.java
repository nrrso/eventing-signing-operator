...
/**
 * Verifies Ed25519 signatures against canonical CloudEvent bytes. Stateless — receives the public
 * key as a parameter.
 */
public class EventVerifier {
    ...
    public static boolean verify(
            byte[] canonical, byte[] signature, Ed25519PublicKeyParameters publicKey) {
