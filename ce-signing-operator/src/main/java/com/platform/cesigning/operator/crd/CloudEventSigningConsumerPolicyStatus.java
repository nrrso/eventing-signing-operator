...
public class CloudEventSigningConsumerPolicyStatus {
    ...
    public List<ConsumerTriggerStatus> getConsumers() {
        return consumers;
    }

    public void setConsumers(List<ConsumerTriggerStatus> consumers) {
    ...
    public static class ConsumerTriggerStatus {
        ...
        public boolean isTriggersReady() {
            return triggersReady;
        }

        public void setTriggersReady(boolean triggersReady) {
            this.triggersReady = triggersReady;
        }
    }
}
