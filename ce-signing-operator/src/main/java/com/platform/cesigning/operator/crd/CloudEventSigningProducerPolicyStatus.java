...
public class CloudEventSigningProducerPolicyStatus {
    ...
    public String getKeyCreated() { return keyCreated; }
    public void setKeyCreated(String keyCreated) { this.keyCreated = keyCreated; }

    public String getKeyExpiresAt() { return keyExpiresAt; }
    public void setKeyExpiresAt(String keyExpiresAt) { this.keyExpiresAt = keyExpiresAt; }

    public List<ProducerStatus> getProducers() { return producers; }
    public void setProducers(List<ProducerStatus> producers) { this.producers = producers; }
    ...
    public static class ProducerStatus {
        ...
        public String getSigningEndpoint() { return signingEndpoint; }
        public void setSigningEndpoint(String signingEndpoint) { this.signingEndpoint = signingEndpoint; }
    }
}
