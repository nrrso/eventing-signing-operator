...
public class VerifyingDeploymentDependentResource
    ...
    static final Set<String> RESERVED_ENV_KEYS = Set.of(
            "CE_SIGNING_MODE", "CE_SIGNING_TRUSTED_NAMESPACES", "CE_SIGNING_REJECT_UNSIGNED");
    ...
    @Override
    protected Deployment desired(CloudEventSigningConsumerPolicy primary,
        ...
        var containerBuilder = builder
                .withNewSpec()
                    ...
                    .withNewTemplate()
                        ...
                        .withNewSpec()
                            .withServiceAccountName(VerifierServiceAccountDependentResource.SERVICE_ACCOUNT_NAME)
                            ...
                            .addNewContainer()
                                ...
                                .addNewEnv().withName("CE_SIGNING_MODE").withValue("verify").endEnv()
                                .addNewEnv().withName("CE_SIGNING_TRUSTED_NAMESPACES").withValue(trustedNs).endEnv()
                                .addNewEnv().withName("CE_SIGNING_REJECT_UNSIGNED").withValue(String.valueOf(spec.isRejectUnsigned())).endEnv();
