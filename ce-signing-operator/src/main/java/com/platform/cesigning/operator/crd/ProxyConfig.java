...
public class ProxyConfig {
    ...
    public void setHpa(HpaConfig hpa) {
        this.hpa = hpa;
    }

    public TopologyConfig getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(TopologyConfig topologySpreadConstraints) {
