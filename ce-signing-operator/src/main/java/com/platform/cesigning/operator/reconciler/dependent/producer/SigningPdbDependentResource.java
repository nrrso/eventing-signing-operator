...
public class SigningPdbDependentResource
        extends CRUDKubernetesDependentResource<PodDisruptionBudget, CloudEventSigningProducerPolicy> {
    ...
    @Override
    protected PodDisruptionBudget desired(CloudEventSigningProducerPolicy primary,
