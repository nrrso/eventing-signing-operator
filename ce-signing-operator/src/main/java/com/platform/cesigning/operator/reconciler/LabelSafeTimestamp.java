...
/**
 * Encodes/decodes timestamps as epoch-seconds strings for use in Kubernetes labels. K8s labels only
 * allow [a-zA-Z0-9._-], so ISO 8601 timestamps (with colons) are invalid.
 */
public final class LabelSafeTimestamp {
    ...
    public static OffsetDateTime decode(String labelValue) {
        return OffsetDateTime.ofInstant(
                Instant.ofEpochSecond(Long.parseLong(labelValue)), ZoneOffset.UTC);
    }
}
